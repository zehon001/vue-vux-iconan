        ...
        bind: function (el, binding, vnode) {
            ...
            el.addEventListener('touchstart', function(e){
                ...
                timeOutLong = setTimeout(() => {
                    timeOutLong = 0;
                    if(type === 'longTouch'){
                         binding.value.func(e,binding.value.param)
                    }
                }, 2000)
            ...
            el.addEventListener('touchmove', function(e){
                ...
                if(type == 'scaleTouch' && e.touches.length === 2){
                    ...
                    binding.value.func(e,scaleSize / 2, false)
                }
                // 如果是移动类型
                if(type == 'slideTouch' && e.touches.length === 1 ){
                    displacement.end = {
                    ...
                    binding.value.func(e,{x:displacement.end.x - displacement.start.x, y: displacement.end.y - displacement.start.y, is_endMove : false})
                }
            }, false)
            el.addEventListener('touchend', function(e){
                if(type === 'scaleTouch'){
                    binding.value.func(e,0, true)
                }
                if(type === 'slideTouch'){
                    binding.value.func(e,{x:0, y: 0, is_endMove : true})
                }
            }, false)
        }
    })
